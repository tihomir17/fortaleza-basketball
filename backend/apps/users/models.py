...
class User(AbstractUser):
    """
    Custom User Model to support different roles within the application.
    """
    ...
    # ADD THIS CLEANED UP SAVE METHOD
    def save(self, *args, **kwargs):
        # Automatically set coach_type to None if the user is not a coach
