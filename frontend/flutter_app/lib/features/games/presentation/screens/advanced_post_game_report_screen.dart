            ...
            data: [
              {
                ...
                'Rank': playTypes['handoffs']['dhos']['rank'],
                'Last5': playTypes['handoffs']['dhos']['last5'].toString(),
                'Rank': playTypes['handoffs']['dhos']['last5_rank'],
                'Season': playTypes['handoffs']['dhos']['season'].toString(),
                'Rank': playTypes['handoffs']['dhos']['season_rank'],
                'xPPP': playTypes['handoffs']['dhos']['xppp'].toString(),
                'Rank': playTypes['handoffs']['dhos']['xppp_rank'],
              },
            ],
          ),
